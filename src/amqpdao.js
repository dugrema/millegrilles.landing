const debug = require('debug')('documents:amqpdao')
const fs = require('fs')
const { MilleGrillesAmqpDAO } = require('@dugrema/millegrilles.nodejs/src/amqpdao')
const { MilleGrillesPKI } = require('@dugrema/millegrilles.nodejs/src/pki')
